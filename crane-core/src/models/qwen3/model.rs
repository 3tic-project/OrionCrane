...
use super::modeling::{BatchDecodeExtractStats, BatchDecodeSetupStats, Config, Qwen3Model};
use crate::fused_ops::PagedAttentionDecodeContext;
...
impl Model {
    ...
    pub fn get_kv_cache_buffers(&self) -> Vec<Option<(Tensor, Tensor)>> {
        self.inner.get_kv_cache_buffers()
    }
    ...
    pub fn last_batch_decode_setup_stats(&self) -> BatchDecodeSetupStats {
        self.inner.last_batch_decode_setup_stats()
    }

    pub fn batch_decode_workspace_generation(&self) -> u64 {
        self.inner.batch_decode_workspace_generation()
    }
    ...
    pub fn step_batch_decode_with_input_ids_fixed_width(
        &mut self,
        input_ids: &Tensor,
        positions: &[usize],
        attention_mask: Option<&Tensor>,
        ...
        self.inner.step_batch_decode_fixed_width(
            input_ids,
            positions,
            attention_mask,
            fixed_cache_width,
    ...
    pub fn step_batch_decode_with_input_ids_fixed_width_and_position_ids(
        &mut self,
        input_ids: &Tensor,
        positions: &[usize],
        position_ids: &Tensor,
        ...
        self.inner.step_batch_decode_fixed_width_with_position_ids(
            input_ids,
            positions,
            position_ids,
            append_offset,
    ...
    pub fn step_batch_decode_with_input_ids_paged_attention(
        &mut self,
        input_ids: &Tensor,
        positions: &[usize],
        attention_mask: Option<&Tensor>,
        paged_attention: &PagedAttentionDecodeContext,
    ) -> candle_core::Result<Tensor> {
        self.inner.step_batch_decode_with_paged_attention(
            input_ids,
            positions,
            attention_mask,
            paged_attention,
    ...
    pub fn last_paged_attention_layer_hits(&self) -> usize {
        self.inner.last_paged_attention_layer_hits()
    }

    pub fn last_paged_attention_layer_fallbacks(&self) -> usize {
        self.inner.last_paged_attention_layer_fallbacks()
    }
    ...
    pub fn last_batch_decode_extract_stats(&self) -> BatchDecodeExtractStats {
        self.inner.last_batch_decode_extract_stats()
    }
